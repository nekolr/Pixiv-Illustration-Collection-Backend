...
import dev.cheerfun.pixivic.infrastructure.execption.VisitOftenException;
...
public class FlowLimitListener {
    ...
    @Pointcut(value = "@annotation(dev.cheerfun.pixivic.infrastructure.annotation.FlowLimit)")
