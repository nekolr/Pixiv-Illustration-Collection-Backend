...
public class ArtistService {
    ...
    public void pullArtistLatestIllust(Integer artistId, String type) {
        IllustsDTO illustrationDetailDTOPage1 = (IllustsDTO) requestUtil.getJsonSync("http://app-api.pixiv.net/v1/user/illusts?user_id=" + artistId + "&offset=0&type=" + type, IllustsDTO.class);
