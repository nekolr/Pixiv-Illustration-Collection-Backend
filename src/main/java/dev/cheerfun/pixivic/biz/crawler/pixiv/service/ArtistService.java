...
public class ArtistService {
    ...
    public void pullArtistLatestIllust(Integer artistId, String type) throws IOException {
        IllustsDTO illustrationDetailDTOPage1 = (IllustsDTO) requestUtil.getJsonSync("http://app-api" + random.nextInt(3) + ".pixivlite.cn/v1/user/illusts?user_id=" + artistId + "&offset=0&type=" + type, IllustsDTO.class);
