...
public class RecommendBizController {
    ...
    public ResponseEntity<Result<List<Illustration>>> recommendBookmarkIllusts(@PathVariable Integer userId, @RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "30") Integer pageSize, @RequestHeader(value = AuthConstant.AUTHORIZATION, required = false) String token) {
    ...
    public ResponseEntity<Result<List<Illustration>>> recommendViewIllusts(@PathVariable Integer userId, @RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "30") Integer pageSize, @RequestHeader(value = AuthConstant.AUTHORIZATION, required = false) String token) {
    ...
    public ResponseEntity<Result<List<Artist>>> recommendArtists(@PathVariable Integer userId, @RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "10") Integer pageSize, @RequestHeader(value = AuthConstant.AUTHORIZATION, required = false) String token) {
