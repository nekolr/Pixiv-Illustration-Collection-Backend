...
public class ArtistAdminController {
    ...
    public ResponseEntity<Result<Boolean>> blockArtistById(@RequestHeader(value = AuthConstant.AUTHORIZATION) String token, @RequestBody List<Integer> artistIdList) {
    ...
    @PermissionRequired(PermissionLevel.ADMIN)
    public ResponseEntity<Result<List<Integer>>> queryBlockArtist(@RequestParam(required = false) Integer artistId, @RequestHeader(value = AuthConstant.AUTHORIZATION) String token) {
    ...
    @PermissionRequired(PermissionLevel.ADMIN)
    public ResponseEntity<Result<Boolean>> removeArtistFromBlockArtist(@PathVariable Integer artistId, @RequestHeader(value = AuthConstant.AUTHORIZATION) String token) {
