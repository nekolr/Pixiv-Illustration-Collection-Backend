...
public class RankController {
    ...
    @GetMapping
    public ResponseEntity<Result<Rank>> queryByDateAndMode(@RequestParam String date, @RequestParam String mode, @RequestParam int page, @RequestParam int pageSize) {
